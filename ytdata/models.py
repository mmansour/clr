...
class YouTuber(Displayable):
    ...
    youtube_views = models.CharField(max_length=40, verbose_name="Youtube Views", blank=True, null=True)
    youtube_subscribers = models.CharField(max_length=40, verbose_name="Youtube Subscribers", blank=True, null=True)
    facebook_likes = models.CharField(max_length=40, verbose_name="Facebook likes", blank=True, null=True)
    twitter_followers = models.CharField(max_length=40, verbose_name="Twitter followers", blank=True, null=True)
    shares = models.CharField(max_length=40, verbose_name="Twitter followers", blank=True, null=True)
